// Code generated by protoc-gen-grpcrouter-bridge. DO NOT EDIT.
...
// handleMethod2 handles Method2 RPC calls (streaming - not yet implemented)
func (b *MyServiceBridge) handleMethod2(requestID string, req *Method2Request) *MyServiceRpcResponse {
	log.Printf("[%s] Method2 (streaming) not yet implemented", b.options.InstanceID)
	return &MyServiceRpcResponse{
		RequestId: requestID,
		Status: &pb.RpcStatus{
			Code:    12, // UNIMPLEMENTED
			Message: "Streaming methods not yet implemented",
		},
		Metadata: make(map[string]string),
	}
}

// handleMethod3 handles Method3 RPC calls (streaming - not yet implemented)
func (b *MyServiceBridge) handleMethod3(requestID string, req *Method3Request) *MyServiceRpcResponse {
	log.Printf("[%s] Method3 (streaming) not yet implemented", b.options.InstanceID)
	return &MyServiceRpcResponse{
		RequestId: requestID,
		Status: &pb.RpcStatus{
			Code:    12, // UNIMPLEMENTED
...
// handleStreamMethod handles StreamMethod RPC calls (streaming - not yet implemented)
func (b *MyServiceBridge) handleStreamMethod(requestID string, req *StreamMethodRequest) *MyServiceRpcResponse {
	log.Printf("[%s] StreamMethod (streaming) not yet implemented", b.options.InstanceID)
	return &MyServiceRpcResponse{
		RequestId: requestID,
		Status: &pb.RpcStatus{
			Code:    12, // UNIMPLEMENTED
