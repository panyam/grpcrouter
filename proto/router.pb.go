...
type InstanceInfo struct {
	...
	HealthStatus HealthStatus `protobuf:"varint,5,opt,name=health_status,json=healthStatus,proto3,enum=grpcrouter.HealthStatus" json:"health_status,omitempty"`
...
type Heartbeat struct {
	...
	HealthStatus  HealthStatus           `protobuf:"varint,3,opt,name=health_status,json=healthStatus,proto3,enum=grpcrouter.HealthStatus" json:"health_status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RpcCall struct {
	...
	MethodType RpcMethodType `protobuf:"varint,3,opt,name=method_type,json=methodType,proto3,enum=grpcrouter.RpcMethodType" json:"method_type,omitempty"`
	// gRPC metadata
	Metadata map[string]string `protobuf:"bytes,4,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Request timeout
...
type StreamMessage struct {
	...
	// Stream control signals
	Control       StreamControl `protobuf:"varint,3,opt,name=control,proto3,enum=grpcrouter.StreamControl" json:"control,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type HealthCheckResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	InstanceId    string                 `protobuf:"bytes,1,opt,name=instance_id,json=instanceId,proto3" json:"instance_id,omitempty"`
	Status        HealthStatus           `protobuf:"varint,2,opt,name=status,proto3,enum=grpcrouter.HealthStatus" json:"status,omitempty"`
	Message       string                 `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListInstancesRequest struct {
	...
	StatusFilter  HealthStatus           `protobuf:"varint,2,opt,name=status_filter,json=statusFilter,proto3,enum=grpcrouter.HealthStatus" json:"status_filter,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_router_proto_rawDesc = "" +
	...
	"grpcrouter\x1a\x19google/protobuf/any.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x93\x02\n" +
	"\x0fRegisterRequest\x12?\n" +
	"\rinstance_info\x18\x01 \x01(\v2\x18.grpcrouter.InstanceInfoH\x00R\finstanceInfo\x125\n" +
	"\theartbeat\x18\x02 \x01(\v2\x15.grpcrouter.HeartbeatH\x00R\theartbeat\x12?\n" +
	"\n" +
	"unregister\x18\x03 \x01(\v2\x1d.grpcrouter.UnregisterRequestH\x00R\n" +
	"unregister\x12<\n" +
	"\frpc_response\x18\x04 \x01(\v2\x17.grpcrouter.RpcResponseH\x00R\vrpcResponseB\t\n" +
	"\arequest\"\xb4\x01\n" +
	"\x10RegisterResponse\x12/\n" +
	"\x03ack\x18\x01 \x01(\v2\x1b.grpcrouter.RegistrationAckH\x00R\x03ack\x120\n" +
	"\brpc_call\x18\x02 \x01(\v2\x13.grpcrouter.RpcCallH\x00R\arpcCall\x121\n" +
	"\x05error\x18\x03 \x01(\v2\x19.grpcrouter.ErrorResponseH\x00R\x05errorB\n" +
	"\n" +
	"\bresponse\"\xef\x02\n" +
	...
	"\bendpoint\x18\x03 \x01(\tR\bendpoint\x12B\n" +
	"\bmetadata\x18\x04 \x03(\v2&.grpcrouter.InstanceInfo.MetadataEntryR\bmetadata\x12=\n" +
	"\rhealth_status\x18\x05 \x01(\x0e2\x18.grpcrouter.HealthStatusR\fhealthStatus\x12?\n" +
	...
	"\rhealth_status\x18\x03 \x01(\x0e2\x18.grpcrouter.HealthStatusR\fhealthStatus\"L\n" +
	...
	"\amessage\x18\x03 \x01(\tR\amessage\"\xaf\x03\n" +
	"\aRpcCall\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x16\n" +
	"\x06method\x18\x02 \x01(\tR\x06method\x12:\n" +
	"\vmethod_type\x18\x03 \x01(\x0e2\x19.grpcrouter.RpcMethodTypeR\n" +
	"methodType\x12=\n" +
	"\bmetadata\x18\x04 \x03(\v2!.grpcrouter.RpcCall.MetadataEntryR\bmetadata\x124\n" +
	"\atimeout\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\atimeout\x120\n" +
	"\arequest\x18\x06 \x01(\v2\x14.google.protobuf.AnyH\x00R\arequest\x12B\n" +
	"\x0estream_message\x18\a \x01(\v2\x19.grpcrouter.StreamMessageH\x00R\rstreamMessage\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\bmetadata\x18\x02 \x03(\v2%.grpcrouter.RpcResponse.MetadataEntryR\bmetadata\x12-\n" +
	"\x06status\x18\x03 \x01(\v2\x15.grpcrouter.RpcStatusR\x06status\x122\n" +
	"\bresponse\x18\x04 \x01(\v2\x14.google.protobuf.AnyH\x00R\bresponse\x12B\n" +
	"\x0estream_message\x18\x05 \x01(\v2\x19.grpcrouter.StreamMessageH\x00R\rstreamMessage\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\t\n" +
	"\apayload\"\x90\x01\n" +
	...
	"\amessage\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\amessage\x123\n" +
	"\acontrol\x18\x03 \x01(\x0e2\x19.grpcrouter.StreamControlR\acontrol\"i\n" +
	"\tRpcStatus\x12\x12\n" +
	...
	"\vinstance_id\x18\x01 \x01(\tR\n" +
	"instanceId\x120\n" +
	"\x06status\x18\x02 \x01(\x0e2\x18.grpcrouter.HealthStatusR\x06status\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\"x\n" +
	"\x14ListInstancesRequest\x12!\n" +
	"\fservice_name\x18\x01 \x01(\tR\vserviceName\x12=\n" +
	"\rstatus_filter\x18\x02 \x01(\x0e2\x18.grpcrouter.HealthStatusR\fstatusFilter\"O\n" +
	"\x15ListInstancesResponse\x126\n" +
	"\tinstances\x18\x01 \x03(\v2\x18.grpcrouter.InstanceInfoR\tinstances*E\n" +
	...
	"\bSTOPPING\x10\x042\xf9\x01\n" +
	"\x06Router\x12I\n" +
	"\bRegister\x12\x1b.grpcrouter.RegisterRequest\x1a\x1c.grpcrouter.RegisterResponse(\x010\x01\x12N\n" +
	"\vHealthCheck\x12\x1e.grpcrouter.HealthCheckRequest\x1a\x1f.grpcrouter.HealthCheckResponse\x12T\n" +
	"\rListInstances\x12 .grpcrouter.ListInstancesRequest\x1a!.grpcrouter.ListInstancesResponseB$Z\"github.com/panyam/grpcrouter/protob\x06proto3"
...
var file_proto_router_proto_goTypes = []any{
	(StreamControl)(0),            // 0: grpcrouter.StreamControl
	(RpcMethodType)(0),            // 1: grpcrouter.RpcMethodType
	(HealthStatus)(0),             // 2: grpcrouter.HealthStatus
	(*RegisterRequest)(nil),       // 3: grpcrouter.RegisterRequest
	(*RegisterResponse)(nil),      // 4: grpcrouter.RegisterResponse
	(*InstanceInfo)(nil),          // 5: grpcrouter.InstanceInfo
	(*Heartbeat)(nil),             // 6: grpcrouter.Heartbeat
	(*UnregisterRequest)(nil),     // 7: grpcrouter.UnregisterRequest
	(*RegistrationAck)(nil),       // 8: grpcrouter.RegistrationAck
	(*RpcCall)(nil),               // 9: grpcrouter.RpcCall
	(*RpcResponse)(nil),           // 10: grpcrouter.RpcResponse
	(*StreamMessage)(nil),         // 11: grpcrouter.StreamMessage
	(*RpcStatus)(nil),             // 12: grpcrouter.RpcStatus
	(*ErrorResponse)(nil),         // 13: grpcrouter.ErrorResponse
	(*HealthCheckRequest)(nil),    // 14: grpcrouter.HealthCheckRequest
	(*HealthCheckResponse)(nil),   // 15: grpcrouter.HealthCheckResponse
	(*ListInstancesRequest)(nil),  // 16: grpcrouter.ListInstancesRequest
	(*ListInstancesResponse)(nil), // 17: grpcrouter.ListInstancesResponse
	nil,                           // 18: grpcrouter.InstanceInfo.MetadataEntry
	nil,                           // 19: grpcrouter.RpcCall.MetadataEntry
	nil,                           // 20: grpcrouter.RpcResponse.MetadataEntry
	(*timestamppb.Timestamp)(nil), // 21: google.protobuf.Timestamp
	(*anypb.Any)(nil),             // 22: google.protobuf.Any
}
var file_proto_router_proto_depIdxs = []int32{
	5,  // 0: grpcrouter.RegisterRequest.instance_info:type_name -> grpcrouter.InstanceInfo
	6,  // 1: grpcrouter.RegisterRequest.heartbeat:type_name -> grpcrouter.Heartbeat
	7,  // 2: grpcrouter.RegisterRequest.unregister:type_name -> grpcrouter.UnregisterRequest
	10, // 3: grpcrouter.RegisterRequest.rpc_response:type_name -> grpcrouter.RpcResponse
	8,  // 4: grpcrouter.RegisterResponse.ack:type_name -> grpcrouter.RegistrationAck
	9,  // 5: grpcrouter.RegisterResponse.rpc_call:type_name -> grpcrouter.RpcCall
	13, // 6: grpcrouter.RegisterResponse.error:type_name -> grpcrouter.ErrorResponse
	18, // 7: grpcrouter.InstanceInfo.metadata:type_name -> grpcrouter.InstanceInfo.MetadataEntry
	2,  // 8: grpcrouter.InstanceInfo.health_status:type_name -> grpcrouter.HealthStatus
	21, // 9: grpcrouter.InstanceInfo.registered_at:type_name -> google.protobuf.Timestamp
	21, // 10: grpcrouter.Heartbeat.timestamp:type_name -> google.protobuf.Timestamp
	2,  // 11: grpcrouter.Heartbeat.health_status:type_name -> grpcrouter.HealthStatus
	1,  // 12: grpcrouter.RpcCall.method_type:type_name -> grpcrouter.RpcMethodType
	19, // 13: grpcrouter.RpcCall.metadata:type_name -> grpcrouter.RpcCall.MetadataEntry
	21, // 14: grpcrouter.RpcCall.timeout:type_name -> google.protobuf.Timestamp
	22, // 15: grpcrouter.RpcCall.request:type_name -> google.protobuf.Any
	11, // 16: grpcrouter.RpcCall.stream_message:type_name -> grpcrouter.StreamMessage
	20, // 17: grpcrouter.RpcResponse.metadata:type_name -> grpcrouter.RpcResponse.MetadataEntry
	12, // 18: grpcrouter.RpcResponse.status:type_name -> grpcrouter.RpcStatus
	22, // 19: grpcrouter.RpcResponse.response:type_name -> google.protobuf.Any
	11, // 20: grpcrouter.RpcResponse.stream_message:type_name -> grpcrouter.StreamMessage
	22, // 21: grpcrouter.StreamMessage.message:type_name -> google.protobuf.Any
	0,  // 22: grpcrouter.StreamMessage.control:type_name -> grpcrouter.StreamControl
	22, // 23: grpcrouter.RpcStatus.details:type_name -> google.protobuf.Any
	2,  // 24: grpcrouter.HealthCheckResponse.status:type_name -> grpcrouter.HealthStatus
	2,  // 25: grpcrouter.ListInstancesRequest.status_filter:type_name -> grpcrouter.HealthStatus
	5,  // 26: grpcrouter.ListInstancesResponse.instances:type_name -> grpcrouter.InstanceInfo
	3,  // 27: grpcrouter.Router.Register:input_type -> grpcrouter.RegisterRequest
	14, // 28: grpcrouter.Router.HealthCheck:input_type -> grpcrouter.HealthCheckRequest
	16, // 29: grpcrouter.Router.ListInstances:input_type -> grpcrouter.ListInstancesRequest
	4,  // 30: grpcrouter.Router.Register:output_type -> grpcrouter.RegisterResponse
	15, // 31: grpcrouter.Router.HealthCheck:output_type -> grpcrouter.HealthCheckResponse
	17, // 32: grpcrouter.Router.ListInstances:output_type -> grpcrouter.ListInstancesResponse
...
func file_proto_router_proto_init() {
	...
	file_proto_router_proto_msgTypes[6].OneofWrappers = []any{
		(*RpcCall_Request)(nil),
