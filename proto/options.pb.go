...
func (RoutingStrategy) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_options_proto_enumTypes[0].Descriptor()
}

func (RoutingStrategy) Type() protoreflect.EnumType {
	return &file_proto_options_proto_enumTypes[0]
}
...
type RoutingOptions struct {
	...
	// Routing strategy
	Strategy RoutingStrategy `protobuf:"varint,3,opt,name=strategy,proto3,enum=grpcrouter.RoutingStrategy" json:"strategy,omitempty"`
...
var file_proto_options_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.ServiceOptions)(nil),
		ExtensionType: (*RoutingOptions)(nil),
		Field:         50001,
		Name:          "grpcrouter.routes_to",
	...
	},
	{
		...
		ExtensionType: (*RoutingOptions)(nil),
		Field:         50002,
		Name:          "grpcrouter.method_routes_to",
...
var (
	// optional grpcrouter.RoutingOptions routes_to = 50001;
	E_RoutesTo = &file_proto_options_proto_extTypes[0]
)

// Extension fields to descriptorpb.MethodOptions.
var (
	// optional grpcrouter.RoutingOptions method_routes_to = 50002;
	E_MethodRoutesTo = &file_proto_options_proto_extTypes[1]
)
...
const file_proto_options_proto_rawDesc = "" +
	"\n" +
	"\x13proto/options.proto\x12\n" +
	"grpcrouter\x1a google/protobuf/descriptor.proto\"\xa5\x01\n" +
	"\x0eRoutingOptions\x12\x18\n" +
	"\aservice\x18\x01 \x01(\tR\aservice\x12\x1f\n" +
	"\vrouting_key\x18\x02 \x01(\tR\n" +
	"routingKey\x127\n" +
	"\bstrategy\x18\x03 \x01(\x0e2\x1b.grpcrouter.RoutingStrategyR\bstrategy\x12\x1f\n" +
	...
	"\fHEADER_BASED\x10\x02:Z\n" +
	"\troutes_to\x12\x1f.google.protobuf.ServiceOptions\x18ц\x03 \x01(\v2\x1a.grpcrouter.RoutingOptionsR\broutesTo:f\n" +
	"\x10method_routes_to\x12\x1e.google.protobuf.MethodOptions\x18҆\x03 \x01(\v2\x1a.grpcrouter.RoutingOptionsR\x0emethodRoutesToB$Z\"github.com/panyam/grpcrouter/protob\x06proto3"
...
var file_proto_options_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_proto_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_options_proto_goTypes = []any{
	(RoutingStrategy)(0),                // 0: grpcrouter.RoutingStrategy
	(*RoutingOptions)(nil),              // 1: grpcrouter.RoutingOptions
	(*descriptorpb.ServiceOptions)(nil), // 2: google.protobuf.ServiceOptions
	(*descriptorpb.MethodOptions)(nil),  // 3: google.protobuf.MethodOptions
}
var file_proto_options_proto_depIdxs = []int32{
	0, // 0: grpcrouter.RoutingOptions.strategy:type_name -> grpcrouter.RoutingStrategy
	2, // 1: grpcrouter.routes_to:extendee -> google.protobuf.ServiceOptions
	3, // 2: grpcrouter.method_routes_to:extendee -> google.protobuf.MethodOptions
	1, // 3: grpcrouter.routes_to:type_name -> grpcrouter.RoutingOptions
	1, // 4: grpcrouter.method_routes_to:type_name -> grpcrouter.RoutingOptions
...
func file_proto_options_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_proto_options_proto_enumTypes,
		MessageInfos:      file_proto_options_proto_msgTypes,
		ExtensionInfos:    file_proto_options_proto_extTypes,
	}.Build()
